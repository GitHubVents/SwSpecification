...
namespace VentsMaterials
{
    public class ToSQL
    {
        ...
        internal string AddMaterialtoXml(int levelID)
        {
            ...
            //var myXml = new XmlTextWriter("C:\\Program Files\\SW-Complex\\vents-materials.sldmat", Encoding.UTF8);
            var myXml = new XmlTextWriter(folderAppData + "\\vents-materials.sldmat", Encoding.UTF8);
            //создаем XML
